...
Also, we did VIF diagnosis and cross validation for models. Similarly, we are not concerned with issues of multicolinearity. As for cross validation results, we  
